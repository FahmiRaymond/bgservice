        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('laporan.commit', $garansi) }}" class="form-horizontal" role="form" method="POST"
                        }}>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="tanggal" name="tanggal" value="{{ $garansi->tanggal }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="pemilik" name="pemilik" value="{{ $garansi->pemilik }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="telepon" name="telepon" readonly value="{{ $garansi->telepon }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="merk" id="merk" type="text" class="form-control" readonly>
                                    ...
                                    <option value="{{ $list->id_merk }}" @if ($list->id_merk === $garansi->id_merk)
                                        selected
                                        @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="model" name="model" readonly value="{{ $garansi->model }}"
                                    oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
                                <span class="help-block with-errors"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="no_imei" name="no_imei" value="{{ $garansi->no_imei }}"
                                    readonly>
                                <span class="help-block with-errors"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="kerusakan" name="kerusakan" readonly value="{{ $garansi->kerusakan }}"
                                    oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
                                <span class="help-block with-errors"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="laba" name="laba" readonly value="{{ $garansi->biaya }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea type="text" class="form-control" id="keterangan" name="keterangan" value="{{ $garansi->keterangan }}"></textarea>
                                <span class="help-block with-errors"></span>
                            </div>
                        </div>
                        <div class="form-group">
